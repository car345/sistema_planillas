...
.custom-modal {
  ...
  width: 100%; /* Define un ancho porcentual para que se adapte a diferentes pantallas */
}
...
ul.options-list li {
  cursor: pointer;
  padding: 10px 20px; /* Ajusta el valor del padding superior e inferior para reducir el espaciado vertical */
  border-radius: 5px;
...
/* Añadir espaciado entre los elementos de la lista */
ul.options-list li + li {
  margin-left: 400px; /* Ajusta el valor para el espaciado horizontal entre elementos */
}
