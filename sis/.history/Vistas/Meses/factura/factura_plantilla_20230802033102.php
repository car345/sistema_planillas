			...
			<td class="info_cliente">
			 ...
			 ?>		
					<tr class="campo">
						...
						<td ><label style="font-size:13px; display:flex">CTA:</label> <p><?php echo $row['CTA_CTE']?></p></td>
							<td ><label style="font-size:12px; display:flex">CARGO:</label> <p ><?php echo $row['CARGO']?></p></td>
							<td><label style="font-size:12px;">SIS.PENSIONARIO:</label> <p><?php echo $row['DESCAF']?></p></td>
						<tr>
