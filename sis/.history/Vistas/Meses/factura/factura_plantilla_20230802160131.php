...
<div id="page_pdf">
	...
	<table id="factura_detalle" >
			...
			<td   width="100px"style="font-size:11px; font-weight:bold">CONCEPTO </td>
			
			<td    class="textrig" style="font-size:11px; font-weight:bold"  >MONTO</td>
