			...
			<td >
			 ...
			 ?>		
					<tr class="campo">
							...
							<td  style="font-size:12px;font-weight: bold; "><label>NOMBRE:</label><p ><?php echo $row['NOMBRE'];?></p></td>
							<td  style="font-size:12px; font-weight: bold;"><label>APELLIDOS:</label><p ><?php echo $row['APELLIDOS'];?></p></td>
