	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td  colspan="2" style="  display:inline-block;"><span> TOTAL DE RENUMERACIONES: <?php echo round($total,3);?></span></td>
					<td  style="display:inline-block;"><span ><?php echo round($total,3);?></span></td>
					<tr>
					</tr>
			</tr>
