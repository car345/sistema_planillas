	...
	<table id="factura_cliente" >
		...
		<tr>
			<td >
			 ...
			 ?>		
					<tr class="campo">
					<td  style="font-size:12px; "><label style="font-weight: bold;">APELLIDOS:</label><p ><?php echo $row['APELLIDOS'];?></p></td>
					<td  style="font-size:12px; "><label style="font-weight: bold;">NOMBRE:</label><p ><?php echo $row['NOMBRE'];?></p></td>
					<td ><label style="font-size:12px; display:flex; font-weight: bold;">D.N.I: </label><p class="campo" ><?php echo $row['NUMERO_DOC']?></p></td>
							
							
							
						
						</tr>
						<td ><label style="font-size:12px; display:flex; font-weight: bold;">CTA:</label> <p><?php echo $row['CTA_CTE']?></p></td>
							<td ><label style="font-size:12px; display:flex; font-weight: bold;">CARGO:</label> <p ><?php echo $row['CARGO']?></p></td>
							<td><label style="font-size:12px; font-weight: bold;">SIS.PENSIONARIO:</label> <p><?php echo $row['DESCAF']?></p></td>
						<tr>
							
							<td  ><label style="font-size:13px;font-weight: bold;">MODALIDAD:</label> <p "><?php echo $row['DESCM']?></p></td>
							<td ><label style="font-size:13px;font-weight: bold;">CATEGORÍA:</label> <p><?php echo $row['DESCC']?></p></td>
							<td colspan="3"><label style="font-size:13px;font-weight: bold;">ÁREA:</label> <p style="font-size:13px;2><?php echo $row['DESCA']?></p></td>
						</tr>
