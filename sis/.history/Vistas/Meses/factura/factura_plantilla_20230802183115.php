	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td  style="  display:block;" ><span style="  display:block; position:absolute; left:300px; top:100px">TOTAL DE DESCUENTOS:<?php echo round($total,3);?></span></td>
				<td  style="  display:block;" ><span style="  display:block; position:absolute; left:300px;bottom:100px">NETO A PERCIBIR:<?php echo round($total,3);?></span></td>
			</tr>
