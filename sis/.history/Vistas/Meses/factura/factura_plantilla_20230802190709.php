...
<div id="page_pdf">
	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr style=" font-size:8px; padding:0; position:absolute; border:none;"><td colspan="2">La presentación de la boleta electrónica puede ser verificada por el QR</td>
		<td>a</td>
		</tr>
