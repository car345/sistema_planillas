	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<span style="font-weight: bold; font-size:10px;">TELÉFONO:</span> </span>062-591060 &nbsp;&nbsp; &nbsp;</p>	<span style="font-weight: bold; font-size:10px;">CORREO:</span> transparencia@unheval.edu.pe</td>
