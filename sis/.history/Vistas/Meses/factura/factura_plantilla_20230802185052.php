...
<div id="page_pdf">
  ...
  <span style="position: fixed; left: 200px; bottom: 200px; padding-right: 10px; ">
    <span style="font-weight: bold; font-size:13px;"> TOTAL DE REMUNERACIONES:</span> <?php echo round($total, 3); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-weight: bold;"> TOTAL DE DESCUENTOS:</span>  <?php echo round($total, 3); ?>
  </span></td>
				<td  style="  display:block; border:none" ><span style="  display:block; position:fixed; left:380px;bottom:150px"> <span style="font-weight: bold;">NETO A PERCIBIR : &nbsp;&nbsp;</span><?php echo round($total,3);?></span></td>
			</tr>
