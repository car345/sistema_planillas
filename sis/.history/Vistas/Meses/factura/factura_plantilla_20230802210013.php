	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<span style="  display:block;   position: fixed;  left: 580px; top:18px;">Cesar Bazan Jaimes:</span>
				<span style="  display:block;   position: fixed;  left: 580px; top:33px;">Jefe de la SURPyC</span>
			</span>
			</td>
