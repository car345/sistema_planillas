...
<tr>
<td><h3>Ingresos</h3>
    <p>Total de ingresos: $1000</p>
    <p>Otro dato de ingreso: $500</p></td>
		<div class="container " style="display:flex">
			
  <div class="ingresos">
    <!-- Aquí coloca los datos de ingresos -->
    <h3>Ingresos</h3>
    <p>Total de ingresos: $1000</p>
    <p>Otro dato de ingreso: $500</p>
  </div>

  <div class="descuentos">
    <!-- Aquí coloca los datos de descuentos -->
    <h3>Descuentos</h3>
    <p>Total de descuentos: $200</p>
    <p>Otro dato de descuento: $50</p>
  </div>
