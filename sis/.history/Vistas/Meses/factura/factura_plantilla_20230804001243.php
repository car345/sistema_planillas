	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<td style="border:none; background:#0a4661; padding:10px;" colspan="3">
			...
			<tr>
				<td style=" padding-right: 10px;font-size:9px;border:none;font-family: Roboto, Arial, sans-serif;">
