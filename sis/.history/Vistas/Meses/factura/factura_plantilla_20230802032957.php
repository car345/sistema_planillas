...
<div id="page_pdf">
    ...
    <div class="datos-alumno">
      <p><strong>Curso:</strong> 5° A</p>
      <p><strong>Número de lista:</strong> 15</p>
    </div>
    <table>
      <tr>
        <th>Asignatura</th>
      ...
      <!-- Aquí irían más filas con otras asignaturas y notas -->
    </table>
    <p class="observaciones"><strong>Observaciones:</strong> El estudiante muestra un buen rendimiento académico y actitud positiva.</p>
    <p class="firma">Firma del docente: __________________</p>
  </div>
	<div class="datos-personales">
			...
			<td class="info_cliente">
			 ...
			 ?>		
					<tr class="campo">
							...
							<td ><label style="font-size:12px; display:flex">CÓDIGO: </label><p class="campo" ><?php echo $row['NUMERO_DOC']?></p></td>
							<td  style="font-size:12px; "><label>NOMBRE:</label><p ><?php echo $row['NOMBRE'];?></p></td>
							<td  style="font-size:12px; "><label>APELLIDOS:</label><p ><?php echo $row['APELLIDOS'];?></p></td>
							
						
						</tr>
						<td ><label style="font-size:12px; display:flex">CTA:</label> <p><?php echo $row['CTA_CTE']?></p></td>
							<td ><label style="font-size:12px; display:flex">CARGO:</label> <p ><?php echo $row['CARGO']?></p></td>
							<td><label style="font-size:12px;">SISTEMA PENSIONARIO:</label> <p><?php echo $row['DESCAF']?></p></td>
						<tr>
