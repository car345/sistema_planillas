...
<div id="page_pdf">
		...
		<tr>
			<td >
				<div class="info_cliente">
					...
					$descuento="SELECT*FROM reportxplanilla where REGMES='$mes' and REGPERSO='$vars' and PROPOR='2'" ;$descmysql=mysqli_query($conn,$descuento);
					$contador=0;
	...
	<table id="factura_detalle" >
			...
			<?php if($row1['IMPORTE']>0) {?>
					...
					?>
								<td class="textright"><?php echo print_r($arreglo['DESCT']); ?></td>
					<?php
