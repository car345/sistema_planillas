	...
	<table id="factura_detalle" >
			<thead>
				...
				<tr>
				 	...
				 	<th width="10px" class="textleft"   >RENUMERACIONES</th>>
					<th class="textright"width="10px"  ></th>
					<th width="2px" style="background:#FFF"></th>
					
					<th width="50px"  class="textleft" >DESCUENTOS</th>
					<th width="50px"  class="textright" width="50px"> </th>
				</tr>
			...
			<td   width="50px"  class="textright" style="font-size:11px; font-weight:bold"  >MONTO</td>
			<td width="4px"   style="background:#FFF"></td>

			<td  width="50px"  style="font-size:11px; font-weight:bold">CONCEPTO </td>
			
			<td  width="50px"  style="font-size:11px; font-weight:bold" >MONTO</td>
			<?php
		...
		<?php
			 ...
			 ?>	
				...
				<td class="textcenter"></td>
					...
					<td class="textright" style="font-size:12px;">
