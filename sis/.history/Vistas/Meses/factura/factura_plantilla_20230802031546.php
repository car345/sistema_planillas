			...
			<td class="info_cliente">
			 ...
			 ?>		
					<tr>
							...
							<td  style="font-size:12px; display:flex"><label>NOMBRE:</label><p ><?php echo $row['NOMBRE'];?></p></td>
							<td  style="font-size:12px; display:flex"><label>APELLIDOS:</label><p ><?php echo $row['APELLIDOS'];?></p></td>
