...
<div id="page_pdf">
	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr style=" font-size:8px; padding:0; position:fixed; padding-top:20px; border:none;"><td style="text-align: center; font-family: Roboto, Arial, sans-serif;">La presentación de la boleta electrónica puede ser verificada por el QR</td>
