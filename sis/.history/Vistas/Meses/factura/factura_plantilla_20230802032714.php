			...
			<td class="info_cliente">
			 ...
			 ?>		
					<tr >
							...
							<td ><label style="font-size:12px; display:flex">COD: </label><p class="campo" ><?php echo $row['NUMERO_DOC']?></p></td>
							<td  style="font-size:12px; "><label>NOMBRE:</label><p class="campo"><?php echo $row['NOMBRE'];?></p></td>
