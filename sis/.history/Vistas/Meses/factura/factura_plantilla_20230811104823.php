...
<div id="page_pdf">
	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th  width="100" class="textright"style="font-size: 11px; font-weight: bold ;border: none"></th>
		
		<th  width="10" class="textright" style="font-size: 11px; font-weight: bold ;border:background: #135FB3; border: none"><?php echo 'S/. '.$total; ?></th>
