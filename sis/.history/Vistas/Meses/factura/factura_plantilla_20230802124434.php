		...
		<tr>
			<td >
			 ...
			 ?>		
					...
					<td  style="font-size:12px; "><label style="font-weight: bold;">NOMBRE:</label><p ><?php echo $row['NOMBRE'];?></p></td><td ><label style="font-size:12px; display:flex; font-weight: bold;">CÓDIGO: </label><p class="campo" ><?php echo $row['NUMERO_DOC']?></p></td>
