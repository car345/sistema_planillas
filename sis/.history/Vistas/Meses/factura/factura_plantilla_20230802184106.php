	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td  style="  display:block;  " ><span style="  display:block; position:fixed; left:200px; bottom:210px">TOTAL DE RENUMERACIONES:<?php echo round($total,3); ?> hrTOTAL DE DESCUENTOS:<?php echo round($total,3);?></span></td>
