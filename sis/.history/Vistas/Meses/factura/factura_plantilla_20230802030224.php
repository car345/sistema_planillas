...
<div id="page_pdf">
    ...
    <div class="datos-personales">
      ...
      <div class="datos-row">
        ...
        <div class="campo">
          <p><strong>Apellido:</strong> Redes</p>
        </div>
        <div class="campo">
          <p><strong>DNI:</strong> 123456789</p>
        </div>
      </div>
      <hr>
    </div>
	...
	<table id="factura_cliente">
		...
		<tr>
			<td class="info_cliente">
			 ...
			 ?>		
					<tr>
							<td ><label style="font-size:12px;">COD:</label><p ><?php echo $row['NUMERO_DOC']?></p></td>
							<td colspan="2"><label>NOMBRE:</label><p style="font-size:11px;"><?php echo $row['NOMBRE'].' '.$row['APELLIDOS'];?></p></td>
