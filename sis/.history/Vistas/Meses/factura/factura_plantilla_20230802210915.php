	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<span style="  display:block; position: absolute; left: 190px;bottom:170px"> 
				...
				<span style="  display:block;   position: fixed;  left: 568px; top:18px; font-weight: bold;">Cesar Bazan Jaimes:</span>
