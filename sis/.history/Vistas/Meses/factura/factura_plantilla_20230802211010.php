	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<span style="  display:block; position: absolute; left: 193px;bottom:170px"> 
				...
				<span style="  display:block;   position: fixed;  left: 570px; top:18px; font-weight: bold;">Cesar Bazan Jaimes:</span>
				<span style="  display:block;   position: fixed;  left: 570px; top:33px;  font-weight: bold">Jefe de la SURPyC</span>
			</span>
			</td>
