	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td style=" display:block; position: fixed; left: 200px; bottom: 120px; padding-right: 10px;font-size:9px;border:none;font-family: Roboto, Arial, sans-serif;"> <span> LUGAR:</span> AV. UNIVERSITARIA N° 601-607 PILLCO MARCA 10003 &nbsp;&nbsp; &nbsp;&nbsp; TELÉFONO:</span>062-591060 &nbsp;&nbsp; &nbsp;&nbsp;CORREO:  transparencia@unheval.edu.pe</p></td>
