	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<td  style="  display:block; border:none ;font-size:9px;" ><span style="  display:block; position:fixed; left: 190px;bottom:170px"> <span style="font-weight: bold ; background-color: #87CEEB;">NETO A PERCIBIR:</span> &nbsp;&nbsp;<?php echo 'S/. '.round(($total-$descuentot),3);?></span></td>
