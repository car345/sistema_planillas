	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td> <div style="border:1px solid black; padding:10px"><img src="<?php echo $base64 ?>" width='100' heigth='100	' /> </div></td>

				<td  style="  display:block;  " ><span style="  display:block; position:fixed; left:400px; bottom:210px">TOTAL DE RENUMERACIONES:<?php echo round($total,3);?> TOTAL DE DESCUENTOS:<?php echo round($total,3);?></span></td>
				<td  style="  display:block; border:none" ><span style="  display:block; position:fixed; left:400px; bottom:180px">TOTAL DE DESCUENTOS:<?php echo round($total,3);?></span></td>
				<td  style="  display:block; border:none" ><span style="  display:block; position:fixed; left:400px;bottom:150px">NETO A PERCIBIR:<?php echo round($total,3);?></span></td>
			</tr>
