...
<div id="page_pdf">
	...
	<table id="factura_detalle" >
			...
			$indiceSeleccionado = $contador;
				if($contador<count($arreglo))
				{
						...
						<td width="4px"   style="background:#FFF; border-bottom:none;" ></td>
								<td ><?php echo $valor['DESCT']; ?></td>
								<td class="textright"><?php echo number_format($valor['IMPORTE'],2); ?></td>
					<?php
						$contador++;
			...
			<tr>
		<th  colspan="1" style="font-size: 11px; font-weight: bold">TOTAL RENUMERACIONES</th>
			<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</td>
			<td width="5px" style="background: #FFF; border: none"></td>
			<th  style="font-size: 11px; font-weight: bold">TOTAL RENUMERACIONES</th>
			<td class="textright" style="font-size: 11px; font-weight: bold">S/.12312</td>	
		</tr>
			<td colspan="4"><hr></td>
