...
<div id="page_pdf">
	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold ;border:background: #135FB3;"><?php echo 'S/. '.$total; ?></th>
		<th class="textright" style="font-size: 11px; font-weight: bold ;border: 1px solidbackground: #135FB3;"></th>
