			...
			<td class="info_cliente">
			 ...
			 ?>		
					<tr>
							...
							<td colspan="2" style="font-size:12px; display:flex"><label>NOMBRE:</label><p style="font-size:11px;"><?php echo $row['NOMBRE'].' '.$row['APELLIDOS'];?></p></td>
							<td ><label style="font-size:12px; display:flex"style="font-size:12px;">CTA:</label> <p><?php echo $row['CTA_CTE']?></p></td>
