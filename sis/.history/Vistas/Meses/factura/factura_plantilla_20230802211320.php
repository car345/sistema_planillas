	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<span style="  display:block; position: absolute; left: 193px;bottom:190px"> 
				...
				<td style="display:block; position: fixed; left: 193px; bottom: 115px; padding-right: 10px;font-size:9px; "><hr width="565px;"style="border-top:none; "></td>
