			...
			<td class="info_cliente">
			 ...
			 ?>		
					<tr>
							...
							<td  style="font-size:12px; display:flex"><label>NOMBRE:</label><p ><?php echo $row['NOMBRE'].' '.$row['APELLIDOS'];?></p></td>
							<td  style="font-size:12px; display:flex"><label>NOMBRE:</label><p ><?php echo $row['APELLIDOS'];?></p></td>
