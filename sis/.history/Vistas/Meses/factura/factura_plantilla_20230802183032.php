	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td  style="  display:block; border-bottom:1px solid black; position:absolute; left:300px;" ><span style="  display:block; ">TOTAL DE RENUMERACIONES:<?php echo round($total,3);?></span></td>
				...
				<td  style="  display:block;" ><span style="  display:block; ">NETO A PERCIBIR:<?php echo round($total,3);?></span></td>
			</tr>
