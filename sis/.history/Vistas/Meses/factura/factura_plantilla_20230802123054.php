		...
		<tr>
			<td >
				<div class="info_cliente">
					<span class="h3  font-weight: bold;">DATOS PERSONALES</span>
			 ...
			 ?>		
					<tr class="campo">
							...
							<td ><label style="font-size:12px; display:flex  font-weight: bold;">CÓDIGO: </label><p class="campo" ><?php echo $row['NUMERO_DOC']?></p></td>
