			 ...
			 ?>		
					...
					<td ><label style="font-size:12px; display:flex; font-weight: bold;">D.N.I: </label><p class="campo" ><?php echo $row['NUMERO_DOC']?></p></td>
						...
						<tr>
							...
							<td  ><label style="font-size:11px;font-weight: bold;">MODALIDAD:</label> <p "><?php echo $row['DESCM']?></p></td>
							<td ><label style="font-size:11px;font-weight: bold;">CATEGORÍA:</label> <p><?php echo $row['DESCC']?></p></td>
							<td colspan="3"><label style="font-size:11px;font-weight: bold;">ÁREA:</label> <p><?php echo $row['DESCA']?></p></td>
						</tr>
