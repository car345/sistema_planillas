	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td  style="  display:block; border:none ;font-size:14px;" ><span style="  display:block; position:fixed; left:375px;bottom:170px"> <span style="font-weight: bold;">NETO A PERCIBIR : &nbsp;&nbsp;</span><?php echo round(($total-$descuentot),3);?></span></td>
				<td style=" display:block; position: fixed; left: 200px; bottom: 120px; padding-right: 10px;font-size:13px;border:none; ">LUGAR: AV. UNIVERSITARIA N° 601-607 PILLCO MARCA 10003 &nbsp;&nbsp; &nbsp;&nbsp; TELÉFONO: </span>  062-591060</p></td>
				<td style=" display:block; position: fixed;  left:375px;bottom:110px; padding-right: 10px;font-size:13px;border:none; ">CORREO: </span> transparencia@unheval.edu.pe</p></td>
			</tr>
