	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<td  style="margin:30px;"> <div style="border:1px solid black; padding:10px;margin:10px;"><img src="<?php echo $base64 ?>" width='105' heigth='105	' /> </div></td>
				<td style="display: block;border:none; ">
				<span  style="position: absolute; left: 185px; bottom: 210px; padding-right: 10px;font-size:14px;border:none; ">
				...
				<td  style="  display:block; border:none ;font-size:9px;" >
				<span style="  display:block; position: absolute; left: 200px;bottom:170px"> 
				<span style="font-weight: bold ; background-color: #87CEEB;">NETO A PERCIBIR:</span> &nbsp;&nbsp;<?php echo 'S/. '.round(($total-$descuentot),3);?>
				<span style="font-weight: bold; position: fixed;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; _______________________________</span>
				<span style="  display:block;   position: fixed;  left: 589px; top:18px; font-weight: bold;">Cesar Bazan Jaimes:</span>
				<span style="  display:block;   position: fixed;  left: 591px; top:33px;  font-weight: bold">Jefe de la SURPyC</span>
			</span>
			</td>
				
				<td style="display:block; position: fixed; left: 184px; bottom: 115px; padding-right: 10px;font-size:9px; "><hr width="565px;"style="border-top:none; "></td>
				<td style=" display:block; position: fixed; left: 179px; bottom: 115px; padding-right: 10px;font-size:9px;border:none;font-family: Roboto, Arial, sans-serif;"> <span style="font-weight: bold; font-size:10px;"> LUGAR:</span> AV. UNIVERSITARIA N° 601-607 PILLCO MARCA 10003 &nbsp;&nbsp; &nbsp;
