	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<td  > <div style="border:1px solid black;  padding:10px;margin:10px; "><img src="<?php echo $base64 ?>" width='100' heigth='100	' /> </div>
				</td>
			
				<td style="border:none; background:#0a4661; padding:0px;" colspan="1">
