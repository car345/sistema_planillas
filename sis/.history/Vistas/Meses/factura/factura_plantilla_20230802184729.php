...
<div id="page_pdf">
  ...
  <span style="position: fixed; left: 200px; bottom: 210px; padding-right: 10px;">
    <span> TOTAL DE REMUNERACIONES:</span> TOTAL DE REMUNERACIONES: <?php echo round($total, 3); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    TOTAL DE DESCUENTOS: <?php echo round($total, 3); ?>
  </span></td>
