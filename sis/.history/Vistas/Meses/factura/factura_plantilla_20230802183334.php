	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td  style="  display:block;  border:none" ><span style="  display:block; position:fixed; left:300px; bottom:180px">TOTAL DE RENUMERACIONES:<?php echo round($total,3);?></span></td>
