...
<div id="page_pdf">
	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<span  style="position: absolute; left: 193px; bottom: 235px; padding-right: 10px;font-size:14px;border:none; ">
				...
				<span style="  display:block; position: absolute; left: 210px;bottom:180px"> 
				...
				<td style="display:block; position: fixed; left: 155px; bottom: 78px; padding-right: 10px;font-size:9px; "><hr width="565px;"style="border-top:none; "></td>
				<td style=" display:block; position: fixed; left: 150px; bottom: 78px; padding-right: 10px;font-size:9px;border:none;font-family: Roboto, Arial, sans-serif;"> <span style="font-weight: bold; font-size:10px;"> LUGAR:</span> AV. UNIVERSITARIA N° 601-607 PILLCO MARCA 10003 &nbsp;&nbsp; &nbsp;
	...
	<div class="label_gracias" style="text-align: center; padding-top:24px;">
