			 ...
			 ?>		
					...
					<td ><label style="font-size:12px; display:flex; font-weight: bold;">D.N.I: </label><p style="font-size:12px;" class="campo" ><?php echo $row['NUMERO_DOC']?></p></td>
						...
						<tr>
							...
							<td  ><label style="font-size:13px;font-weight: bold; border:none;">MODALIDAD:</label> <p style="font-size:12px;"><?php echo $row['DESCM']?></p></td>
							<td ><label style="font-size:13px;font-weight: bold;border:none;">CATEGORÍA:</label> <p style="font-size:12px;"><?php echo $row['DESCC']?></p></td>
