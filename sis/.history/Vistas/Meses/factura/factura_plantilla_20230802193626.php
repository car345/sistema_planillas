...
<div id="page_pdf">
	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr >
				...
				<td  style="background:black;"style="margin:30px;"> <div style="border:1px solid black; padding:10px;margin:10px;"><img src="<?php echo $base64 ?>" width='100' heigth='100	' /> </div></td>
				<td style="display: block;border:none;">
				<span  style="position: fixed; left: 200px; bottom: 210px; padding-right: 10px;font-size:14px;border:none; ">
					<span style="font-weight: bold; "> TOTAL DE REMUNERACIONES:</span> <?php echo 'S/. '.round($total, 3); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span style="font-weight: bold;"> TOTAL DE DESCUENTOS:</span>  <?php echo 'S/. '.round($descuentot,3);?>
				</span></td>
				<td  style="  display:block; border:none ;font-size:9px;" ><span style="  display:block; position:fixed; left:375px;bottom:170px"> <span style="font-weight: bold;">NETO A PERCIBIR : &nbsp;&nbsp;</span><?php echo 'S/. '.round(($total-$descuentot),3);?></span></td>
				...
				<td style=" display:block; position: fixed; left: 200px; bottom: 120px; padding-right: 10px;font-size:9px;border:none; ">LUGAR: AV. UNIVERSITARIA N° 601-607 PILLCO MARCA 10003 &nbsp;&nbsp; &nbsp;&nbsp; TELÉFONO: </span>  062-591060 &nbsp;&nbsp; &nbsp;&nbsp;CORREO:  transparencia@unheval.edu.pe</p></td>
	...
	<h4  >¡Gracias por su labor en la Universidad! </h4>
	</div>
</div>
</body>
</html>