	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td style=" display:block; position: fixed; left: 200px; bottom: 120px; padding-right: 10px;font-size:13px;border:none; ">CORREO: </span> transparencia@unheval.edu.pe</p></td>
			</tr>
