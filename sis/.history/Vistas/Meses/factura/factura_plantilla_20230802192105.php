	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td style=" display:block; position: fixed;  left:375px;bottom:110px; padding-right: 10px;font-size:9px;border:none; ">CORREO: </span> transparencia@unheval.edu.pe</p></td>
			</tr>
