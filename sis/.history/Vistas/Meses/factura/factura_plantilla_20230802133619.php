...
<div id="page_pdf">
	...
	<table id="factura_detalle" class="table-bordered">
			...
			<td class="textleft" width="180px">CONCEPTO</td>>
					<td class="textleft" width="160px">MONTO</td>
					<td width="4px" style="background:#FFF"></td>
					<td class="textleft" width="160px">CONCEPTO</td>
					<td class="textright" width="40px">MONTO</td>
			<tr>
	<td>
