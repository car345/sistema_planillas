	...
	<table id="factura_detalle" class="table-bordered">
			<thead>
				...
				<tr>
				 ...
				 <th class="textleft" width="180px">RENUMERACIONES</th>>
					<th class="textleft" width="160px"></th>
					<th width="4px" style="background:#FFF"></th>
					
					<th class="textleft" >DESCUENTOS</th>
					<th class="textright" width="40px"> </th>
				</tr>
			</thead>
			<tbody id="detalle_productos"  >
			<tr>
			<td width="20px" style="font-size:11px; font-weight:bold">CONCEPTO </td>
			
			<td  class="textright"  style="font-size:11px; font-weight:bold" colspan="" >MONTO</td>
			<td width="4px"  colspan="2" style="background:#FFF"></td>

			<td  style="font-size:11px; font-weight:bold">CONCEPTO </td>
			
			<td   style="font-size:11px; font-weight:bold" colspan="" >MONTO</td>
