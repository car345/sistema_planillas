	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td  style="  display:block; border:none ;font-size:9px;" ><span style="  display:block; position:fixed; left:375px;bottom:170px"> <span style="font-weight: bold;">NETO A PERCIBIR : &nbsp;&nbsp;</span><?php echo round(($total-$descuentot),3);?></span></td>
