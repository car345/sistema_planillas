	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<td style=" display:block; position: fixed; left: 179px; bottom: 135px; padding-right: 10px;font-size:9px;border:none;font-family: Roboto, Arial, sans-serif;"> <span style="font-weight: bold; font-size:10px;"> LUGAR:</span> AV. UNIVERSITARIA N° 601-607 PILLCO MARCA 10003 &nbsp;&nbsp; &nbsp;
