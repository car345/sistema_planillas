	...
	<table id="factura_cliente">
		...
		<tr>
			<td class="info_cliente">
			 ...
			 ?>		
					<tr>
							<td colspan="2" ><label style="font-size:12px; display:flex">COD: </label><p ><?php echo $row['NUMERO_DOC']?></p></td>
							<td colspan="2" style="font-size:12px; display:flex"><label>NOMBRE:</label><p ><?php echo $row['NOMBRE'].' '.$row['APELLIDOS'];?></p></td>
							<td colspan="2"><label style="font-size:12px; display:flex">CTA:</label> <p><?php echo $row['CTA_CTE']?></p></td>
							<td colspan="2"><label style="font-size:12px; display:flex">CARGO:</label> <p ><?php echo $row['CARGO']?></p></td>
