	...
	<table id="factura_detalle" >
		...
		<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			...
			<tr>
				...
				<td  style=" padding-left:150px"><span>TOTAL DE RENUMERACIONES:</span></td>
					<td colspan="2"class="textright"><span ><?php echo round($total,3);?></span></td>
					<tr>
					</tr>
			</tr>
				...
				<?php  } ?>
				<vscode-file://vscode-app/c:/Users/admi/AppData/Local/Programs/Microsoft%20VS%20Code/resources/app/out/vs/code/electron-sandbox/workbench/workbench.html/tr>
