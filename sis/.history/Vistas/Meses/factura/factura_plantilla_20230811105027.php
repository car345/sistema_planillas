	...
	<table id="factura_detalle"  style="border:none;">
			...
			$indiceSeleccionado = $contador;
				if($contador<count($arreglo))
				{
						...
						<td   style="font-size:11px;" ><?php echo $valor['CODIGO']; ?></td>
		...
		<th    class="textleft" width="	" class="textright"style="font-size: 11px; font-weight: bold ;border: none">a</th>
		
		<th   class="textleft" style="font-size: 11px; font-weight: bold ;border:background: #135FB3; border: none"><?php echo 'S/. '.$total; ?></th>
