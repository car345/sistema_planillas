	...
	<table id="factura_detalle"  style="border:none;">
			<thead  style="border:none;">
				...
				<tr style="border:none;">
				 	...
				 	<th  style ="background:#0a4661" class="textleft"   >RENUMERACIONES</th >
					 <th style ="background:#0a4661" width="100"> </th>
					 <th style ="background:#0a4661" width="50"> </th>
					<th width="1px"style="background:#FFF;border-bottom:none"></th>
			...
			<td class="textcenter"style="font-size: 11px; font-weight: bold">CONCEPTO</td>
