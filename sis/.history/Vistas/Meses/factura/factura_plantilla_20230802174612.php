...
<div id="page_pdf">
	...
	<table id="factura_detalle" >
			...
			<tr>
		<th  colspan="1" class="textleft"  style="font-size: 11px; font-weight: bold">TOTAL DE RENUMERACIONES</th>
			<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>
			<td width="5px" style="background: #FFF; border: none"></td>
			<th  class="textleft" style="font-size: 11px; font-weight: bold">TOTAL DE  DESCUENTOS</th>
			<th class="textright" style="font-size: 11px; font-weight: bold">S/.12312</th>	
		</tr>
			<td colspan="4"><hr></td>
