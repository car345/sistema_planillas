	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<span style="  display:block; position: absolute; left: 200px;bottom:170px"> <span style="font-weight: bold ; background-color: #87CEEB;">NETO A PERCIBIR:</span> &nbsp;&nbsp;<?php echo 'S/. '.round(($total-$descuentot),3);?></span>
			</td>
