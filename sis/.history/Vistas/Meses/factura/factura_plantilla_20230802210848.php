	...
	<table id="factura_detalle"  style="border:none;">
		...
		<th class="textright" style="font-size: 11px; font-weight: bold"><?php echo 'S/. '.$total; ?></th>
			...
			<tr>
				...
				<span style="  display:block; position: absolute; left: 180px;bottom:170px"> 
				...
				<span style="  display:block;   position: fixed;  left: 575px; top:33px;  font-weight: bold">Jefe de la SURPyC</span>
			</span>
			</td>
