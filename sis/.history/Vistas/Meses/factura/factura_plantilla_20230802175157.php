	...
	<table id="factura_detalle" >
			<thead>
				...
				<tr>
					...
					<th width="220px"> </th>
					<th style="background:#FFF;border-bottom:white"></th>
			...
			<tbody id="detalle_productos"   style="border: 1px solid #135FB3;">
			<tr>
			...
			<?php if($row1['IMPORTE']>0) {?>
					...
					<td  style="font-size:11px;border-bottom:none !important;"><?php
