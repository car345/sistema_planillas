...
function abrirPagina(mes) {
    var campoEntradames = document.getElementById("id_usuario"+mes);
    var valorCampo = campoEntradames.value.trim();
    if (valorCampo === '') {
      window.open("http://localhost/sis/vistas/Meses/armarplanilla2.php?id="+mes+'&es=0', "_blank");
    }
  }
...
for (var i = 0; i < openModalLinks.length; i++) {
    openModalLinks[i].addEventListener('click', function(event) {
        ...
        window.addEventListener("load", function() {
          var campoEntrada = document.getElementById('id_usuario'+id);
