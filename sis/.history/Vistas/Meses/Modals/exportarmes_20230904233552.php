...
<div class="modal fade" id="exportarmes<?php echo  $data["id_meses"];?>"  tabindex="-1">
 ...
 <!-- planillas -->
  ...
  <span>
    <hr>
   <span class="fw-bold" style=" color: #2471a3;">MODALIDAD DE PLANILLA</span>
...
<span>
  <br>
  <span  style=" color: #2471a3;" class="fw-bold">TIPO DE PLANILLA</span>
  ...
  <span class="fw-bold" style=" color: #2471a3;">FILTRAR</span>
  ...
  <span>
    <div class="row row-2 fila">
      <label for="" style=" color: #2471a3;">Modalidad</label>
...
<!-- descuento ley -->
  ...
  <br>
  <span class="py-2">
  <span class="fw-bold" style=" color: #2471a3;">TIPO DE DESCUENTO LEY</span >
  ...
  <span style=" color: #2471a3;" class="fw-bold">FILTRAR</span>
  ...
  <br>
  <div class="row row-2">
   <label for="" class="fw-bold" style=" color: #2471a3;">SISTEMA PENSIONARIO</label>
  ...
  <br>
  <span>
  <span class="fw-bold" style=" color: #2471a3;">TIPO DE RESUMEN DE MODALIDAD</span>
...
<form   id="frm<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
    ...
    <u><span style=" color: #2471a3;" class="fw-bold">DATOS DEL TRABAJADOR</span></u>
    <div class="col-xl-3"  > 
      <span class="fw-bold" style=" color: #2471a3;" >DNI</span> <input class="form-control w-100"  type="text" name="id_usuario<?php echo  $data["id_meses"];?>" id="id_usuario<?php echo  $data["id_meses"];?>"   required>
    </div>
    <div class="col-xl-4"> 
      <span class="fw-bold" style=" color: #2471a3;"  style=" padding:1px" >  NOMBRE</span><input  name="NOMBRE"  autocomplete="off" type="text" class="form-control" id="NOMBRE<?php echo  $data["id_meses"];?>"  required disabled > 
    </div>
    <div class="col-xl-5"> 
      <span  class="fw-bold"  style=" color: #2471a3;" style=" padding:1px" >  APELLIDO</span><input  name="APELLIDOS"  autocomplete="off" type="text" class="form-control" id="APELLIDOS<?php echo  $data["id_meses"];?>"  required disabled > 
    </div>
  </form>
</div>
<div class="py-3">
...
<form   id="frms<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
    ...
    <u><span style=" color: #2471a3;" class="fw-bold">DATOS DEL TRABAJADOR</span></u>
    <div class="col-xl-3"  > 
      <span  style=" color: #2471a3;" class="fw-bold">DNI</span> <input class="form-control w-100"  type="text" name="id_usuarios<?php echo  $data["id_meses"];?>" id="id_usuarios<?php echo  $data["id_meses"];?>"   required>
    </div>
    <div class="col-xl-4"> 
      <span  style=" color: #2471a3;"class="fw-bold" style=" padding:1px" >  NOMBRE</span><input  name="NOMBRE"  autocomplete="off" type="text" class="form-control" id="NOMBRESS<?php echo  $data["id_meses"];?>" onchange="habilitarvalue(<?php echo  $data["id_meses"];?>)"  required disabled  > 
    </div>
    <div class="col-xl-5"> 
      <span   style=" color: #2471a3;"class="fw-bold" style=" padding:1px" >  APELLIDOS</span><input  name="APELLIDOS"  autocomplete="off" type="text" class="form-control" id="APELLIDOSS<?php echo  $data["id_meses"];?>"  required disabled > 
    </div>
  </form>

</div>

  <div id="value_dni<?php echo  $data["id_meses"];?>"  style="display:none;">
<div class="row " >


  <div class="col-sm-6 ">
<label style=" color: #2471a3;" class="fw-bold py-1"> <u>FECHA DEL TRABAJADOR </u></label><br>

  <div class="dates" style=" color: #2471a3;" >
  <label class="fw-bold">DESDE</label>
    <input type="text-center"  class="form-control" id="fecha1<?php echo  $data["id_meses"];?>" name="event_date" placeholder="YYYY-MM-DD" autocomplete="off">
  </div>
...
<div class="col-sm-6 ">
  ...
  <label ></label ><br>
    ...
    <input type="text"  class="form-control" id="fecha2<?php echo  $data["id_meses"];?>" name="event_date" placeholder="YYYY-MM-DD" autocomplete="off">
  </div>
</div>
...
<br>
  <span >
  <span class="fw-bold" style=" color: #2471a3;">TIPO DE TRABAJADORES</span>
  ...
  <span class="fw-bold" style=" color: #2471a3;">ACCIÓN</span>
    ...
    <span class="fw-bold"  style=" color: #2471a3;">MODALIDAD </span>
       ...
       user.addEventListener('keyup', function(event) {
            ...
            .then(data => {
                if (data) {
                    ...
                    $('#value_dni' + ids).css('display', 'block');
              
                } else 
                {$('#NOMBRESS'+ids).val("");
                  $('#APELLIDOSS'+ids).val("");
                  $('#value_dni' + ids).css('display', 'none');
                    console.log('Respuesta vacía del servidor');
                }
            })
            .catch(error => {
