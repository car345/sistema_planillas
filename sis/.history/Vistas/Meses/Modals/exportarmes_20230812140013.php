...
<div class="row px-1" >
    ...
    <input type="month" name="fecha1<?php echo  $data["id_meses"];?>" id="fecha1<?php echo  $data["id_meses"];?>" class="form-control">

      <span class="col-sm-6"> Hasta :</span>
    <input type="month" name="fecha2<?php echo  $data["id_meses"];?>" id="fecha2<?php echo  $data["id_meses"];?>" class="form-control">
  </div>
  <div class="py-3">
  <button type="button" onclick="constancia_haberes($('#id_usuarios'+<?php echo  $data["id_meses"];?>).val(),<?php echo  $data["id_meses"];?>)" class="btn btn-primary w-100">Proceder boleta</button>
</div>
</div>
</div>
