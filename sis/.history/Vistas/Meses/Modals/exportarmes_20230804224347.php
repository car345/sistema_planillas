...
<span>
  ...
  <span>
  <span class="fw-bold">TIPO DE DESCUENTOS</span>
    <select  data-id="<?php echo  $data["id_meses"];?>"   name="tippform<?php echo  $data["id_meses"];?>" id="tippdesc<?php echo  $data["id_meses"];?>" onchange="habilitarInputplanil(<?php echo  $data["id_meses"];?>)" class="form-select">
      <option value="">Seleccione una opcion</option>
      <option value="DESCLEY">DESCUENTOS</option>
      <option value="DESCLEY_MENUSAL"> DESCUENTO X MES</option>
    </select>
