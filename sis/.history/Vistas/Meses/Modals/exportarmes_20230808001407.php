...
const modalidades = document.getElementById("modalidades" + idMeses); // Aquí usas idMeses que definiste previamente
const idMesesValue = modalidades.getAttribute("data-id-meses");

console.log(idMesesValue)
