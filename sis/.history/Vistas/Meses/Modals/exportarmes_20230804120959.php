...
<div class="modal fade" id="exportarmes<?php echo  $data["id_meses"];?>"  tabindex="-1">
            <div class="modal-dialog modal-lg" style="border-radius: 10px;">
                <div class="modal-content bg-light w-100 m-lg-3 "  >
                    <div class="modal-header bg-light   " style="justify-content:center;">
                        <p style=" font-family: 'Oswald' !important; font-size:30px; justify-content:center;">REPORTE DEL MES</p>
                  ...
                  <li data-tab="planilla-mensual">Descuentos</li>
                  <li data-tab="planilla-mensual">Resumen por </li>
                  <li data-tab="planilla-mensual">Planilla Mensual</li>
                  <li data-tab="planilla-mensual">Planilla Mensual</li>
                  <li data-tab="planilla-mensual">Planilla Mensual</li>
                  <li data-tab="descuento-ley">Descuento Ley</li>
                  <li data-tab="descuento-mensual">Descuento Mensual</li>
                </ul>
