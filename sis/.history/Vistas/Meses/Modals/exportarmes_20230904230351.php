...
<form   id="frms<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
    ...
    <div class="col-xl-4"> 
      <span class="fw-bold" style=" padding:1px" >  NOMBRE</span><input  name="NOMBRE"  autocomplete="off" type="text" class="form-control" id="NOMBRESS<?php echo  $data["id_meses"];?>" onchange="habilitarvalue(<?php echo  $data["id_meses"];?>)"  required disabled  > 
    </div>
    <div class="col-xl-5"> 
...
// activacion tipo descuento //
      ...
      function habilitarvalue(evento) {
      var tipp = document.getElementById('NOMBRESS' + evento);
      var inputHabilitadotipp = document.getElementById('value_dni' + evento); 
