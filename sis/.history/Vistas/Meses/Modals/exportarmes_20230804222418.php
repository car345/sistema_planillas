...
<form   id="frms<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
    <div class="col-sm-6" style="display:none;">
      <label   for=""> <span style=" padding:1px">id_meses</span> <input class="form-control" placeholder="id" type="hidden" name="id_mesess<?php echo  $data["id_meses"];?>" id="id_meses<?php echo  $data["id_meses"];?>" ></label> 
    </div>
