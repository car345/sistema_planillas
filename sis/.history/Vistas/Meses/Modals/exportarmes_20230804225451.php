...
<span>
  ...
  <span class="fw-bold">ACCIÓN</span>
    <select  data-id="<?php echo  $data["id_meses"];?>"   name="tippA<?php echo  $data["id_meses"];?>" id="tippnom<?php echo  $data["id_meses"];?>" onchange="habilitarInputplanil(<?php echo  $data["id_meses"];?>)" class="form-select">
      <option value="">Seleccione una opcion</option>
