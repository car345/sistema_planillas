...
<!-- Reporte items -->
  ...
  <hr>
   <span class="fw-bold">MODALIDAD DE PLANILLA</span>
    <select name="modalplanmodali<?php echo  $data["id_meses"];?>" id="modalplandesc  <?php echo  $data["id_meses"];?>" class="form-select">
      <option value="">Seleccione una opcion</option>
      <option value="PENSIONISTAS">PENSIONISTAS</option>
    </select> 
  </span>
  <span>
  <span class="fw-bold">TIPO DE RESUMEN DE MODALIDAD</span>
    <select  data-id="<?php echo  $data["id_meses"];?>"   name="tippmodali<?php echo  $data["id_meses"];?>" id="tippdesc<?php echo  $data["id_meses"];?>" onchange="habilitarInputplanil(<?php echo  $data["id_meses"];?>)" class="form-select">
      <option value="">Seleccione una opcion</option>
      <option value="DESCLEY">REPORTE POR ITEMS</option>
      <option value="DESCLEY_MENUSAL"> REPORTE POR ITEMS MENSUAL</option>
    </select>
  </span>

  <div  class="py-2">
  <button class="btn btn-block w-100" style="background-color: #1976D2; " onclick="items(<?php echo $data["id_meses"];?>)"> Reporte de Items</button>
  </div>
