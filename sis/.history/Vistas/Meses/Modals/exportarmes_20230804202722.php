...
<div class="row " style="padding:px 40px 10px 10px;">
...
<div class="col-sm-12" style="padding:0px 0px 0px 10px;">
    <label for="" > <span class="fw-bold" style=" padding:1px" >  NOMBRE</span><input  name="NOMBRE"  autocomplete="off" type="text" class="form-control" id="NOMBRE<?php echo  $data["id_meses"];?>"  required disabled > </label>
</div>
<div class="" style="padding:0px 0px 0px 10px;">
    <label for="" > <span  class="fw-bold" style=" padding:1px" >  APELLIDO</span><input  name="APELLIDOS"  autocomplete="off" type="text" class="form-control" id="APELLIDOS<?php echo  $data["id_meses"];?>"  required disabled > </label>
</div>  
</div>
</form>
<div class="row">
<form   id="frm<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
  ...
  <div class="col-xl-6" style="background:#1976D2" > 
    <label   for=""> <span class="fw-bold" style=" padding:1px">DNI</span> <input class="form-control w-100"  type="text" name="id_usuario<?php echo  $data["id_meses"];?>" id="id_usuario<?php echo  $data["id_meses"];?>"   required></label> 
  </div>
  <div class="col-md-12"> 
  <label for="" > <span class="fw-bold" style=" padding:1px" >  NOMBRE</span><input  name="NOMBRE"  autocomplete="off" type="text" class="form-control" id="NOMBRE<?php echo  $data["id_meses"];?>"  required disabled > </label>
  </div>
