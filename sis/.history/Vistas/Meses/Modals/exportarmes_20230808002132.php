...
<span>
  ...
  <div class="row row-2">
                  ...
                  <div class="btn-group col-sm-1  ">
                    ...
                    <br>
                <input type="text" class="form-control " data-id-meses="<?php echo $data["id_meses"]; ?>" id=modalidad_input>
...
const inputElement = document.querySelector("[data-id-meses]");
    if (inputElement) {
      const idMeses = inputElement.getAttribute("data-id-meses");
      console.log(idMeses);
    } else {
