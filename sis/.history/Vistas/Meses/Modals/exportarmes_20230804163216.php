...
<span>
  <span class="fw-bold">TIPO DE PLANILLA</span>
    <select  data-id="<?php echo  $data["id_meses"];?>"   name="tipp<?php echo  $data["id_meses"];?>" id="tipp<?php echo  $data["id_meses"];?>" onchange="habilitarInput(<?php echo  $data["id_meses"];?>)" class="form-select">
    <option value="">Seleccione una opcion</option>
