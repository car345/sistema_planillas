...
<div class="py-3">
  <button type="button" onclick="user($('#id_usuario'+<?php echo  $data["id_meses"];?>).val(),<?php echo  $data["id_meses"];?>)" class="btn btn-primary w-100">Buscar trabajador</button>
</div>
<div>
<div class="row px-1" >
    ...
    <input type="month" name="fecha1" id="fecha1<?php echo  $data["id_meses"];?>" class="form-control">

      <span class="col-sm-6"> Hasta :</span>
    <input type="month" name="fecha2" id="fecha2<?php echo  $data["id_meses"];?>" class="form-control">
  </div>
  <div class="py-3">
  <button type="button" onclick="constancia_haberes($('#id_usuario'+<?php echo  $data["id_meses"];?>).val(),<?php echo  $data["id_meses"];?>)" class="btn btn-primary w-100">Proceder boleta</button>
</div>
</div>
</div>
...
function removeErrorMessage(input) {
  ...
  function desc_ley(mes,param1,param2)
  {
   ...
   function constancia_haberes(mes,user,fecha1,fecha2)
   {
    var fecha1 =$('#fecha1'+mes).val(); 
    var fecha2 =$('#fecha2'+mes).val(); 
    var ancho = 1000;
    var alto = 800;
    // Calcular posocion x,y para centrar la ventana
    var x = parseInt((window.screen.width/2) - (ancho / 2));
    ...
    $url = 'facturas/generarconstanciahaberes.php?m='+mes+'&user'+user+'&fecha1='+fecha1+'&fecha2'+fecha2;
    // Posciones
    window.open($url,"facturas","left="+x+",top="+y+",height="+alto+",width="+ancho+",scrollbar=si,location=no,resizable=si,menubar=no");
