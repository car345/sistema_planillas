  ...
  <div class="row row-2">
   <label for="" class="fw-bold">SISTEMA PENSIONARIO</label>
     ...
     <input type="text" class="form-control"    id ="cod_modal_desc<?php echo $data["id_meses"]; ?>"></div>
            ...
            <div class="btn-group  col-sm-7">
              <input type="text" class="form-control " id='NOMBREMODAL_DESC<?php echo $data["id_meses"]; ?>' disabled > <p class="mx-4"> Hasta</p></div></div>
            <div class="row row-2">
            ...
            <div class="btn-group  col-md-7 my-2">
              <input type="text" class="form-control "  id='NOMBREMODAL_DESC_FINAL<?php echo $data["id_meses"]; ?>'disabled ><p class="mx-4"></p></div>
            </div>
  </span>
  <span clas="py-3">
    <button type="button" onclick="desc_ley(<?php echo $data["id_meses"]; ?>,$('#NOMBREMODAL_DESC<?php echo  $data["id_meses"];?>').val(),$('#NOMBREMODAL_DESC_FINAL<?php echo  $data["id_meses"];?>' ))" class="btn btn-success w-100 fw-bold" style="background-color: #1976D2; ">REPRESENTAR DESCUENTO LEY</button>
    </span>
  </div>
