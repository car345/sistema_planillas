...
<form   id="frm<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
  ...
  <div class="col-sm-6"> 
    <label   for=""> <span class="fw-bold" style=" padding:1px">DNI</span> <input class="form-control "  type="text" name="id_usuario<?php echo  $data["id_meses"];?>" id="id_usuario<?php echo  $data["id_meses"];?>"   required></label> </div>
  </form>
</div>
</div>
