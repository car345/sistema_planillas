...
<form  class="row row-col-3"  id="frm<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
<div class="row row-col-3 " style="padding:px 40px 10px 10px;">
<div class="col-sm-10" style="padding:0px 0px 0px 10px; display:none;">
