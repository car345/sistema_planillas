...
<!-- descuento ley -->
  ...
  <span clas="py-5">
    <button clas="py-5" type="button" onclick="desc_ley(<?php echo $data["id_meses"]; ?>,$('#NOMBREMODAL_DESC<?php echo  $data["id_meses"];?>').val(),$('#NOMBREMODAL_DESC_FINAL<?php echo  $data["id_meses"];?>' ).val())" class="btn btn-success w-100 fw-bold" style="background-color: #1976D2; ">REPRESENTAR DESCUENTO LEY</button>
    </span>
