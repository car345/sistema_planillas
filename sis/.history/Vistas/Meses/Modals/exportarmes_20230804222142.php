...
<form   id="frms<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
    ...
    <div class="col-xl-3"  > 
      <span class="fw-bold">DNI</span> <input class="form-control w-100"  type="text" name="id_usuarios<?php echo  $data["id_meses"];?>" id="id_usuario<?php echo  $data["id_meses"];?>"   required>
    </div>
    <div class="col-xl-4"> 
    ...
    <div class="col-xl-5"> 
      <span  class="fw-bold" style=" padding:1px" >  APELLIDO</span><input  name="APELLIDOS"  autocomplete="off" type="text" class="form-control" id="APELLIDOSS<?php echo  $data["id_meses"];?>"  required disabled > 
    </div>
  </form>
...
<div class="row" >
    <span> FECHA</span>
    <span class="col-sm-6"> Mes Desde: </span>
