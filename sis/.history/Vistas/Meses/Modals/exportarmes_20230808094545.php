...
<span>
  ...
  <div class="py-2">
<button class="btn btn-block btn-outline text-white w-100 fw-bold" onclick="planilla(<?php echo  $data["id_meses"];?>,$("#NOMBREMODAL<?php echo  $data["id_meses"];?>").val(),$("#NOMBREMODAL_FINAL<?php echo  $data["id_meses"];?>"))" style="background-color: #1976D2; " >REPRESENTAR LA PLANILLA</button>
</div>
  </div>
<!-- descuento ley -->
