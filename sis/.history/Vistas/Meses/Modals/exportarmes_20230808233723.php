...
<!-- descuento ley -->
  ...
  <span class="fw-bold">FILTRAR</span>
    <select data-id="<?php echo  $data["id_meses"];?>"  name="" id="filtrardesc<?php echo  $data["id_meses"];?>" onchange="habilitarInputdesc(<?php echo  $data["id_meses"];?>)" class="form-select">
    <option value="">Seleccione una opcion</option>
    <option value="MODALIDADES">SISTEMA PENSIONARIOS</option>
...
function removeErrorMessage(input) {
  ...
  if (errorMessage) {
    errorMessage.textContent = ""; // Limpiar el contenido del mensaje de error
     ...
     var inputHabilitado = document.getElementById('modalidadesdesc' + event);
     var inputHabilitados = document.getElementById('afs' + event);
     if (modalidadInput.value === 'MODALIDADES') {
       inputHabilitado.style.display = 'block';
       inputHabilitados.style.display = 'none';  // Habilitar el input
     } else if(modalidadInput.value === 'AREAS') {
