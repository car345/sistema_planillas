...
<div class="modal fade" id="exportarmes<?php echo  $data["id_meses"];?>"  tabindex="-1">
    ...
    <li data-tab="descgen<?php echo  $data["id_meses"];?>">Descuento. Generales</li>
    ...
    <li data-tab="nomintrab<?php echo  $data["id_meses"];?>">Nomina de Trabajadores x Actividad</li>
    <li data-tab="descintrab<?php echo  $data["id_meses"];?>">Desc. de Trabajadores x Actividad</li>
...
<!-- Reporte items -->
  ...
  <div  class="py-2">
  <button class="btn btn-block w-100" onclick="items(<?php echo $data["id_meses"];?>)"> Reporte de Items</button>
  </div>
