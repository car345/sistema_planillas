...
<span>
  ...
  <span class="fw-bold">CTA CTE </span>
    <select  data-id="<?php echo  $data["id_meses"];?>"   name="tippaCT<?php echo  $data["id_meses"];?>" id="tippaccion<?php echo  $data["id_meses"];?>" onchange="habilitarInputplanil(<?php echo  $data["id_meses"];?>)" class="form-select">
      <option value="">Seleccione una opcion</option>
