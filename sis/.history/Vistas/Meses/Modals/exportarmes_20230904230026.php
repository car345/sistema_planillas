...
<form   id="frms<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
    ...
    <div class="col-xl-4"> 
      <span class="fw-bold" style=" padding:1px" >  NOMBRE</span><input  name="NOMBRE"  autocomplete="off" type="text" class="form-control" id="NOMBRESS<?php echo  $data["id_meses"];?>"  required disabled  onchange="habilitarInput_desc(<?php echo  $data["id_meses"];?>)"> 
    </div>
    <div class="col-xl-5"> 
...
// activacion tipo descuento //
      ...
      var tipp = document.getElementById('value_dni' + evento);
      var inputHabilitadotipp = document.getElementById('filtraropcionesdesc' + evento); 
