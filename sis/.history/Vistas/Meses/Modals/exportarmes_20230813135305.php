...
<div class="row px-1" >
  ...
  <div class="py-3">
  <button type="button" onclick="constancia_haberes($('#id_usuarios'+<?php echo  $data["id_meses"];?>).val(),<?php echo  $data["id_meses"];?>)" class="btn btn-primary w-100">Generarconstanciahaberes</button>
</div>
</div>
</div>
