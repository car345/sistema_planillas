...
<!-- descuento ley -->
  ...
  <span clas="py-3">
    <button type="button" onclick="desc_ley(<?php echo $data["id_meses"]; ?>,$('#NOMBREMODAL<?php echo  $data["id_meses"];?>').val(),$('#NOMBREMODAL_FINAL<?php echo  $data["id_meses"];?>' ))" class="btn btn-success w-100 fw-bold" style="background-color: #1976D2; ">REPRESENTAR DESCUENTO LEY</button>
    </span>
  </div>
