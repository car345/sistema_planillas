...
<form   id="frms<?php echo  $data["id_meses"];?>" method="POST" action="#" enctype="multipart/form-data">
    ...
    <div class="col-xl-3"  > 
      <span class="fw-bold">DNI</span> <input class="form-control w-100"  type="text" name="id_usuarios<?php echo  $data["id_meses"];?>" id="id_usuariosS<?php echo  $data["id_meses"];?>"   required>
    </div>
    <div class="col-xl-4"> 
      <span class="fw-bold" style=" padding:1px" >  NOMBRE</span><input  name="NOMBRE"  autocomplete="off" type="text" class="form-control" id="NOMBRESSs<?php echo  $data["id_meses"];?>"  required disabled > 
    </div>
    <div class="col-xl-5"> 
       ...
       user.addEventListener('keyup', function(event) {
            ...
            .then(data => {
                if (data) {
                    var jsonData = JSON.parse(data);
                    console.log('Respuesta del servidor:', jsonData);
                    $('#NOMBRES'+ids).val(jsonData.NOMBRE);
