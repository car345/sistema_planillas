...
function insertErrorMessage(input, message) {
  ...
  errorMessage.style.display = "none"; // Ocultar el mensaje de error por defecto
...
function planilla(id_meses) {
  if (validateForm(id_meses)) {
    // Hacer algo si la validación es exitosa
    // Por ejemplo, enviar el formulario o realizar otras acciones
  }
}
