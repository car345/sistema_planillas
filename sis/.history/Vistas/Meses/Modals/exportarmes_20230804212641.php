...
<!-- Reporte items -->
  ...
  <label for="">Desde: <input type="text " class="form-control"></label><br>
  <label for="">Hasta: <input type="text " class="form-control"></label><br>
  <label for="">Hasta: <input type="text " class="form-control"></label>
