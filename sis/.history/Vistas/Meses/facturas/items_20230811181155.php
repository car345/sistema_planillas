            ...
            ?>
     		<tr>
                <td style="font-size:11px; font-size:normal;"colspan="1"   ><?php echo $i;?></td>
                    ...
                    <td style="font-size:11px; font-size:normal;"colspan="115"   ><?php echo $persona['NOMBRE']; ?></td>
                    <td style="font-size:11px; font-size:normal;"colspan="9"   ><?php echo $persona['DESCT_CAT']; ?></td>
