...
?></th> </tr>
            ...
            ?>
            <tr><td style=" font-size:13px;font-weight:bold;"   colspan="1" >Item: </td> 
            <th style=" font-size:13px;font-weight:bold;"   colspan="1" ><?php echo $valores['CODIGO'].' '.$valores['DESCT']; ?> </th>  
