...
?></th> </tr>
        ...
        $contador=0;
            ...
            $codigo="SELECT DISTINCT  CODIGO,DESCT FROM reportxplanilla where REGMES='$mes' AND DESCT NOT IN ('dds051-91','sobrevive') ORDER BY CODIGO LIMIT 1 " ;
 ...
 ?>
 <tr>
       <td colspan='22'></td><td colspan='48' style=' font-size:11px; font-weight:normal;    letter-spacing:1px;'>Totales: <?php
