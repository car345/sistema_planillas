<?php
 ...
 $fecha1 = $_POST['fecha1']; // Obtén fecha1 desde tus datos (ejemplo: "2023-12")
$fecha2 = $_POST['fecha2']; // Obtén fecha2 desde tus datos (ejemplo: "2023-06")
...
<div id="page_pdf">
	...
	<tbody>
        ...
        <?php 
        $sql = "SELECT * FROM  WHERE fecha_columna BETWEEN '$fecha1' AND '$fecha2'";
        ?>
    <tr>
