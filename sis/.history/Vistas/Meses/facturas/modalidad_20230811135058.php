...
<div id="page_pdf">
	...
	?>
		...
		<tr>
					...
					<td colspan="5"> </td>
					<td style="font-size:12px" colspan="15"><?php echo number_format($resultz1['tots4'],2); ?></td>
					<td style="font-size:12px" colspan="15"><?php echo number_format($resulty1['tots5'],2); ?></td>
