...
<div id="page_pdf">
	...
	<tr><th style=" font-size:14px; font-weight: normal;"   colspan="70" >Descuentos de Ley del Mes : <tr> <th style="justify-content:center;font-size:13px;"  colspan="23" >Correspondiente al mes :
			<?php
