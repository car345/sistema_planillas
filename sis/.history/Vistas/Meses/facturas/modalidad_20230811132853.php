	...
	<br>
		<thead>
				<tr>
					...
					<td style="font-size:12px; font-weight:bold" colspan="7" >DESCRIPCIÓN</td>
			 ...
			 ?>
				<tr>
				   ...
				   {   }else {  
					...
					<td style="font-size:12px" colspan="7"><?php echo $row['DESCT']; ?></td>
			...
			<tr>
				<td   style="font-size:12px;" colspan="2"><?php echo '1999' ?></td>
					<td  style="font-size:12px" colspan="7"><?php echo 'TOTAL'  ?></td>
