...
<div id="page_pdf">
	...
	<br>
		<thead>
			...
			?>
			<tr>
			<td  colspan="2" style="font-size:12px;"><?php echo '1999' ?></td>
					<td  colspan="2"style="font-size:12px"><?php echo 'TOTAL'  ?></td>
					<td  colspan="10"style="font-size:12px"><?php echo $totrx,2; ?></td>
					<td  colspan="15"style="font-size:12px"><?php echo number_format($totry,2); ?></td>
					<td  colspan="15"style="font-size:12px"><?php echo number_format($totrz,2); ?></td> 
