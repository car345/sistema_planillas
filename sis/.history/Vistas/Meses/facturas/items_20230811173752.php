...
?></td>
            ...
            $codigo="SELECT DISTINCT  CODIGO,DESCT FROM reportxplanilla where REGMES='$mes' AND DESCT NOT IN ('sindurgenc','sinaguinal','sindu037','dds051-91','sobrevive') ORDER BY CODIGO" ;
