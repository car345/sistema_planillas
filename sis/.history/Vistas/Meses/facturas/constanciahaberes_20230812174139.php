...
<div id="page_pdf">
	...
	<br>
        ...
        <?php
        $array=array();
        $sql="SELECT DISTINCT CODIGO ,DESCT from renumeraciones group by CODIGO,DESCT LIMIT 20";
       ...
       foreach($array as $indice => $valor)
       {
        ...
        <td style="font-size:10px;" colspan="2"><?php echo $valor['DESCT']; ?> </td>
      <?php if(($indice+1)%20==0){  ?>
        <tr></tr>
        <?php 
     }
