...
<tr>
			...
			<tr>
					...
					<td colspan="5"> </td>
					<td style="font-size:12px" colspan="15"><?php echo number_format($totry + $totrx1,2); ?></td>
					<td style="font-size:12px" colspan="15	"><?php echo number_format($totrz + $totrx1,2); ?></td> 
					<td style="font-size:12px" colspan="5" ><?php echo  number_format($total,2); ?></td>
			</tr>
			</tbody>
