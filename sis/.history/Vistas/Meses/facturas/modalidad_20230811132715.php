	...
	<br>
		<thead>
				<tr>
					...
					<td style="font-size:12px; font-weight:bold" colspan="4" >DESCRIPCIÓN</td>
			 ...
			 ?>
				<tr>
				   ...
				   {   }else {  
					...
					<td style="font-size:12px" colspan="4"><?php echo $row['DESCT']; ?></td>
			...
			<tr>
				<td   style="font-size:12px;" colspan="2"><?php echo '1999' ?></td>
					<td  style="font-size:12px" colspan="3"><?php echo 'TOTAL'  ?></td>
					
					<td style="font-size:12px"colspan="5"> <?php echo number_format($totrx,2); ?></td>
					<td style="font-size:12px" colspan="14"><?php echo number_format($totry,2); ?></td>
					<td style="font-size:12px" colspan="14	"><?php echo number_format($totrz,2); ?></td> 
					<td style="font-size:12px" colspan="5" ><?php echo  number_format($total,2); ?></td> </tr>
