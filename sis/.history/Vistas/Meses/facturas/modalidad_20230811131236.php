	...
	<br>
		<thead>
				<tr>
					...
					<td style="font-size:12px; font-weight:bold" colspan="3" >DESCRIPCIÓN</td>
					...
					<td style="font-size:12px; font-weight:bold"  colspan="3" >ORFANDAD</td>
			 ...
			 ?>
				<tr>
				   ...
				   {   }else {  
					...
					?>
					<td  style="font-size:12px;" colspan="3"><?php echo $row['CODIGO']; ?></td>
