...
<div id="page_pdf">
	...
	<table  >
	<tr><th style=" font-size:11px; font-weight: normal; position:absolute; left:30px;"   colspan="65" >UNIVERSIDAD NACIONAL "HERMILIO VALDIZAN"- HUÀNUCO</th> </tr>
	<tr><th style=" font-size:13px; font-weight: normal;"   colspan="60" >Descuentos de Ley del Mes de Enero 2023</th> </tr>
	<br>
	<tr><td style="justify-content:center; font-size:11px;"   colspan="5" >Sistema Pensionario :ESSALUD-CES</td> </tr>
	<br>
		<thead>
				<tr>
