	...
	<br>
		<thead>
				<tr>
					...
					<td style="font-size:12px; font-weight:bold" colspan="2" >DESCRIPCIÓN</td>
					<td style="font-size:12px; font-weight:bold " colspan="3" >PENSIONISTAS</td>
					<td style="font-size:12px; font-weight:bold"  colspan="8" >VIUDEZ</td>
					<td style="font-size:12px; font-weight:bold"  colspan="5" >ORFANDAD</td>
					<td style="font-size:12px; font-weight:bold"  colspan="20" >TOTAL</td>
				</tr>
				</thead>
			<tbody>
			<?php
			 ...
			 ?>
				<tr>
				   ...
				   {   }else {  
					...
					<td style="font-size:12px" colspan="2"><?php echo $row['DESCT']; ?></td>
					<td style="font-size:12px" colspan="6"><?php echo number_format($resultx['tots'],2); ?></td>
					
					<td style="font-size:12px" colspan="8"><?php echo number_format($resultz['tots2'],2); ?></td>
					<td style="font-size:12px" colspan="4"><?php echo number_format($resulty['tots1'],2); ?></td>
