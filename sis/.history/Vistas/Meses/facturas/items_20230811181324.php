...
?></th> </tr>
		...
		<tr style=" font-size:11px; font-weight:bold;"    ><td colspan="1"><?php echo 'MODALIDAD' ?><td>: PENSIONISTAS'</td> </td> </tr> 
				<tr>
					...
					<td style="font-size:12px;  "colspan="22" >Nombres.</td>
					<td style="font-size:12px; "  colspan="18">Categoría</td>
            ...
            ?>
     		<tr>
                <td style="font-size:11px; font-size:normal;"colspan="1"   ><?php echo $i;?></td>
                    ...
                    <td style="font-size:11px; font-size:normal;"colspan="22"   ><?php echo $persona['NOMBRE']; ?></td>
                    <td style="font-size:11px; font-size:normal;"colspan="20"   ><?php echo $persona['DESCT_CAT']; ?></td>
