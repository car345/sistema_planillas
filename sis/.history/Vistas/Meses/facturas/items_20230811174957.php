...
?></td>
            ...
            $codigo="SELECT DISTINCT  CODIGO,DESCT FROM reportxplanilla where REGMES='$mes' AND DESCT NOT IN ('dds051-91','sobrevive') ORDER BY CODIGO" ;
		...
		<tr style=" font-size:11px; font-weight:normal"    ><td colspan="1"><?php echo 'Modalidad' ?><td>: PENSIONISTAS'</td> </td> </tr> 
				<tr>
            ...
            $sqlren=$conn->query($ren);//arreglo de trabajadores de planilla//
            ...
            ?>
     		<tr>
                <td style="font-size:11px; font-size:normal;"colspan="1"   ><?php echo $i;?></td>
                    ...
                    <td style="font-size:11px; font-size:normal;"colspan="1"   ><?php echo round((double)$report['IMPORTE'],2); ?></td>
				</tr>
