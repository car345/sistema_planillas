...
<div id="page_pdf">
	...
	<tr><th style=" font-size:14px; font-weight: normal;"   colspan="75" > <tr> <th style="justify-content:center;font-size:13px;"  colspan="23" >Correspondiente al mes :
			<?php
...
$monthName1 = $mesesEnEspanol[$monthNum];
echo $monthName.' '.$mesac['anio'].' hasta '.$monthName.' '.$mesac['anio'];
?></th> </tr>
	<br>
