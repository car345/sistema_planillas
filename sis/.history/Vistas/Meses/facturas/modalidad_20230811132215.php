		...
		<thead>
			 ...
			 ?>
				<tr>
				   ...
				   {   }else {  
					...
					<td style="font-size:12px" colspan="5"><?php echo number_format($resultx['tots'],2); ?></td>
					
					<td style="font-size:12px" colspan="20"><?php echo number_format($resultz['tots2'],2); ?></td>
			...
			<tr>
				<td   style="font-size:12px;" colspan="2"><?php echo '1999' ?></td>
					<td  style="font-size:12px" colspan="2"><?php echo 'TOTAL'  ?></td>
					<td style="font-size:12px" colspan="2"><?php echo $totrx,2; ?></td>
					<td style="font-size:12px" colspan="3"><?php echo number_format($totry,2); ?></td>
					<td style="font-size:12px" colspan="15"> <?php echo number_format($totrz,2); ?></td> 
					<td style="font-size:12px" colspan="15"><?php echo  number_format($total,2); ?></td> </tr>
