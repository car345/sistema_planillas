...
?></th> </tr>
        ...
        $contador=0;
          ...
          <tr></tr>
                <tr><td colspan='1'></td>
                    <td colspan='16'> </td>
                    <td colspan='28' style=' font-size:11px; font-weight:normal;    letter-spacing:1px;'>TOTAL MODALIDAD: </td>
                    <td  style=' font-size:11px; font-weight:normal;' ><?php echo number_format($total,2); ?></td>
                </tr>
           <?php 
        unset($renum);
        $totalf+=$total;
