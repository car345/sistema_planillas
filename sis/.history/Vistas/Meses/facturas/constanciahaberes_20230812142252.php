...
<div id="page_pdf">
	...
	<br>
		<thead>
            <tr> 
                <td  style=" font-size:15px; font-weight: normal; "> DNI:</td>
            </tr>
            <tr>
                <td  style=" font-size:15px; font-weight: normal; ">APELLIDOS</td>
                <td  style=" font-size:15px; font-weight: normal; ">NOMBRES</td>
            </tr>
				</thead>
