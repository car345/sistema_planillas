...
<div id="page_pdf">
	...
	?>
		...
		<tr>
					...
					<td colspan="5"> </td>
					<td style="font-size:12px" colspan="15"><?php echo number_format($resultz3['tots4'],2); ?></td>
					<td style="font-size:12px" colspan="15"><?php echo number_format($resulty2['tots5'],2); ?></td>
