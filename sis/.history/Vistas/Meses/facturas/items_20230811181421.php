            ...
            ?>
     		<tr>
                <td style="font-size:12px; font-size:normal;"colspan="1"   ><?php echo $i;?></td>
                    ...
                    <td style="font-size:132px; font-size:normal;"colspan="1"   ><?php echo $persona['APELLIDOS']; ?></td>
                    <td style="font-size:1px; font-size:normal;"colspan="22"   ><?php echo $persona['NOMBRE']; ?></td>
