...
?></th> </tr>
        ...
        $contador=0;
            ...
            $codigo="SELECT DISTINCT  CODIGO,DESCT FROM reportxplanilla where REGMES='$mes' AND DESCT NOT IN ('dds051-91','sobrevive') ORDER BY CODIGO  " ;
                  ...
                  $num_rows1 =mysqli_num_rows($codigosql);
            ...
            ?>
            <tr><td style=" font-size:13px;font-weight:bold;"    >Item: </td> 
            <td style=" font-size:13px;font-weight:bold;"   colspan="1" ><u><?php echo $valores['CODIGO'].' '.$valores['DESCT']; ?> </td>  
          ...
          <tr></tr>
                <tr><td colspan='1'></td>
                    <td colspan='16'> </td>
                    <td colspan='28' style=' font-size:10px; font-weight:normal;    letter-spacing:1px;'>TOTAL MODALIDAD: </td>
                    <td  style=' font-size:10px; font-weight:normal;' ><?php echo number_format($total,2); ?></td>
                </tr>
           <?php 
        unset($renum);
        $totalf+=$total;
 ...
 ?>
 <tr>
       <td colspan='23'></td><td colspan='48' style=' font-size:11px; font-weight:normal;    letter-spacing:1px;'>Totales: <?php
