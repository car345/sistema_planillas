	...
	<br>
		<thead>
				<tr>
					...
					<td style="font-size:10px; "  colspan="20">Codigo Afp.</td>
					<td style="font-size:10px; "  colspan="19">Codigo IPSS.</td>
					<td style="font-size:10px; "  colspan="13">Des Ley</td>
				</tr>
				</thead>
			<tbody>
			<?php
...
$i=1;
			 ...
			 ?>
				<tr>
					...
					<td style="font-size:10px" colspan="22"><?php echo $descuento['CODIGO_IPS']; ?></td>
					<td style="font-size:10px"colspan="2"><?php echo $importe; ?></td>
