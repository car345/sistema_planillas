...
<div id="page_pdf">
	...
	<br>
		<thead>
			...
			?>
			<tr>
				<td   style="font-size:12px;" colspan="15"><?php echo '1999' ?></td>
					<td  style="font-size:12px" colspan="15"><?php echo 'TOTAL'  ?></td>
					<td style="font-size:12px" colspan="15"><?php echo $totrx,2; ?></td>
