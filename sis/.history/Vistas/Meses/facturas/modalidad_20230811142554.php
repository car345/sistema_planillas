...
<tr>
			...
			<tr>
					...
					<td style="font-size:12px" colspan="15	"><?php echo number_format($totrz + $totrz1,2); ?></td> 
					<td style="font-size:12px" colspan="15"><?php echo number_format($totry + $totry1,2); ?></td>
