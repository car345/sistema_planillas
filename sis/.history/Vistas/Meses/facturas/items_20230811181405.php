            ...
            ?>
     		<tr>
                <td style="font-size:12px; font-size:normal;"colspan="1"   ><?php echo $i;?></td>
                    ...
                    <td style="font-size:12px; font-size:normal;"colspan="22"   ><?php echo $persona['NOMBRE']; ?></td>
                    <td style="font-size:12px; font-size:normal;"colspan="20"   ><?php echo $persona['DESCT_CAT']; ?></td>
