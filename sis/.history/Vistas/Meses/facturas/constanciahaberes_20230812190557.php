...
<div id="page_pdf">
	...
	<br>
		<thead>
        <?php  $ev="SELECT d.CODIGO,d.APELLIDOS,d.NOMBRE,cat.DESC,af.id_afps FROM datperso d inner join categori cat on d.id_categori=cat.id_categori inner join afps af on d.id_afps=af.id_afps where d.CODIGO ='$user'";
                        $reev=$conn -> query($ev);
