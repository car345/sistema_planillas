...
?></th> </tr>
		...
		<tr style=" font-size:11px; font-weight:bold;"    ><td colspan="1"><?php echo 'MODALIDAD' ?><td>: PENSIONISTAS'</td> </td> </tr> 
				<tr>
					<td style="font-size:13px; "colspan="1"   >Num</td>
                    <td style="font-size:13px; " colspan="1"  >Código</td>
					<td style="font-size:13px; " colspan="1" >Apellidos</td>
					<td style="font-size:13px;  "colspan="22" >Nombres.</td>
					<td style="font-size:13px; "  colspan="19">Categoría</td>
					<td style="font-size:13px; "  colspan="3">Importe</td>
				</tr>
            ...
            ?>
     		<tr>
                <td style="font-size:13px; font-size:normal;"colspan="1"   ><?php echo $i;?></td>
                    ...
                    <td style="font-size:13px; font-size:normal;"colspan="22"   ><?php echo $persona['NOMBRE']; ?></td>
                    <td style="font-size:13px; font-size:normal;"colspan="20"   ><?php echo $persona['DESCT_CAT']; ?></td>
