...
?></th> </tr>
            ...
            ?>
            <tr><td style=" font-size:12px;font-weight:bold;"   colspan="1" >Item: </td> 
            <th style=" font-size:12px;font-weight:bold;"   colspan="1" ><?php echo $valores['CODIGO'].' '.$valores['DESCT']; ?> </th>  
            
        </tr>       
		<tr style=" font-size:11px; font-weight:bold;"    ><td colspan="1"><?php echo 'MODALIDAD' ?><td>: PENSIONISTAS'</td> </td> </tr> 
				<tr>
					<td style="font-size:12px; "colspan="1"   >Num</td>
                    <td style="font-size:12px; " colspan="1"  >Código</td>
					<td style="font-size:12px; " colspan="1" >Apellidos</td>
					<td style="font-size:12px;  "colspan="20" >Nombres.</td>
					<td style="font-size:12px; "  colspan="15">Categoría</td>
            ...
            {  } else { echo 'MODALIDADx:' ?><td style=" font-size:11px; font-weight:normal" ><?php echo $fetchm['DESC']; ?></td <?php } ?> </td> </tr> <?php 
            if(isset($renum))
            {
            ...
            ?>
     		<tr>
                <td style="font-size:11px; font-size:normal;"colspan="1"   ><?php echo $i;?></td>
					<td style="font-size:11px; font-size:normal;"colspan="1"   ><?php echo $persona['codigo']; ?></td>
                    <td style="font-size:11px; font-size:normal;"colspan="1"   ><?php echo $persona['APELLIDOS']; ?></td>
                    <td style="font-size:11px; font-size:normal;"colspan="18"   ><?php echo $persona['NOMBRE']; ?></td>
                    <td style="font-size:11px; font-size:normal;"colspan="17"   ><?php echo $persona['DESCT_CAT']; ?></td>
                    <td style="font-size:11px; font-size:normal;"colspan="1"   ><?php echo number_format(round((double)$report['IMPORTE'],2),2); ?></td>
				</tr>
          ...
          $i++;}}  } ?>
                <tr><td colspan='14'></td>
                    <td colspan='30' style=' font-size:11px; font-weight:normal;    letter-spacing:1px;'>Total modalidad: <?php
