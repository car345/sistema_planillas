			 ...
			 ?>
				<tr>
				   ...
				   {   }else {  
					...
					<td style="font-size:12px" colspan="14"><?php echo number_format($resultz['tots2'],2); ?></td>
					<td style="font-size:12px" colspan="14"><?php echo number_format($resulty['tots1'],2); ?></td>
