...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <!-- <li>
            <a href="http://localhost/sis/Vistas/Items_nomina/in.php">
              <i class="bi bi-circle"></i><span>Items Nomina (proceso)</span>
            </a>
          </li> -->
          <li>
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-general.html">
              <i class="bi bi-circle"></i><span>Copia de Seguridad</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
              <i class="bi bi-circle"></i><span>Eliminar Archivos Indices</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
              <i class="bi bi-circle"></i><span>Trabajadores sin programa</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
              <i class="bi bi-circle"></i><span>Arreglar programa sector actividad</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
              <i class="bi bi-circle"></i><span>Estructura Tabla -Manual </span>
            </a>
          </li>
        </ul>
      </li>End Tables Nav -->
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="http://localhost/sis/sistema.php">Home</a></li>
    ...
    <section class="section dashboard">
	 ...
	 <h4 class="fw-bold">BIENVENIDOS A SISPLANILLAS <i class="bi bi-card-list"></i></h4>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy;  Desarrolladores de la UNHEVAL
    </div> 
  </footer><!-- End Footer -->
