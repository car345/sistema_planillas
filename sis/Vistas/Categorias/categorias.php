...
<main id="main" class="main">
    ...
    <!-- <div class="col-sm-6"  >
             <button type="button" class="btn btn-warning m-3 text-white " data-bs-toggle="modal"  data-bs-target="#agregarcategoria" href="" id="nueva_curso" > <i class="fa fa-plus"></i> Agregar Categorias</button>
          </div> -->
    ...
    <div class="row ">
    <div class="col-sm-4"  >
             <button type="button" class="btn btn-warning m-3 text-white " data-bs-toggle="modal"  data-bs-target="#agregarcategoria" href="" id="nueva_curso" ><i class="bi bi-plus-square"></i> AGREGAR CATEGORIA</button>
          </div>
          <!-- <div class="col-sm-4"  >
          <form method="post" class="form" action="./excel/categoria_excel.php">
    ...
    <div class="table-responsive"> 
          <table class="table table-bordered border-blue  table-light mt-3" >
            ...
            <tbody>
<?php
                  $columns = ['p.id_categori', 'p.DESC', 'p.BASFEDU'];
                  $table = 'categori p';
                  $id = 'p.id_categori';
                ...
                $result=mysqli_num_rows($query);
                 ...
                 ?>
                  <tr >
                    ...
                    <td><?php  echo  substr($data['BASFEDU'],0,$max_length="30"); ?></td>
                    <td> 
                   <a class="btn btn-success"  data-bs-toggle="modal" data-bs-target="#actualizarcategoria<?php echo $data["id_categori"];?>" > <i class="fa fa-dashboard"> </i>Editar </a>   
                 </td>
                 <td>
                 <a class=" btn btn-danger text-center"   onclick="eliminar('<?php echo $data["id_categori"]; ?>')" >  Eliminar </a>
                 </td>
                  </tr>
                  <?php 
...
<span class='fw-bold'>Agregar Categoría</span>
                  ...
                  <div class="modal-body" >
                      <form  class="row row-col-2"  id="frm" method="POST" action="#" enctype="multipart/form-data">
                          ...
                          <div class="col-sm-6" >
                            <label   for=""> <h6 style=" padding:1px">ID CATEGORIA</h6> <input class="form-control" id="id_categoria" type="text" name="id_categoria" required></label> 
                          </div>
                          <div class="col-sm-6" style="padding:0px 0px 0px 10px;">
                             <label for="" class="align-content-center"> <h6 style=" padding:1px" >  DESCRIPCION</h6><input  name="descripcion_categoria"  autocomplete="off" type="text" class="form-control" id="descripcion_categoria"  required > </label>
                          </div>
                          <div class="col-sm-6" style="padding:0px 0px 0px 10px;">
                             <label for="" class="align-content-center"> <h6 style=" padding:1px" >  BASFEDU </h6><input  name="basfedu_categoria"  autocomplete="off" type="text" class="form-control" id="basfedu_categoria"  required > </label>
                          </div>  
                          <button class=" btn px-3 btn-primary btn  mt-3" style="position:relative;left: 7px;"    type="button" id="registrar"  >Registrar Categoria</button>
                          <div>
