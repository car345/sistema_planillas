...
if(isset($_POST))
{
    ...
    $queryRg ="INSERT INTO aportes(REGISTRO, CODIGO,CODIGOC,DESCT,APORTE,LEE,IMP,VER,AUXILIAR,ANULAR,ENCARGADO,INICIALIZA,
    AFECTO,VABSOLUTO,TIPOCR,id_categori,DETALLE,TRABA_EMP,FECHA,FECHA2) VALUES ($id,'$codigo','$cc','$glosa','$formula','$leer','$imprimir'
    ,'$ver','$auxliar','$anular','$encargado','$init','$afecto','$val','$tcr','$categoria',
    '$detalle','$traba_emp','$fecha','$fecha2')";
    $resultado = mysqli_query($conn, $$queryRg);
     echo "ok";  
