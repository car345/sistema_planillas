...
<main id="main" class="main">
    ...
    <div class="row ">
    <div class="col-sm-3"  >
             <button type="button" class="btn btn-warning m-3 text-white " data-bs-toggle="modal"  data-bs-target="#agregarplanilla" href="" id="nueva_curso" ><i class="bi bi-plus-square"></i> AGREGAR PARTIDA</button>
          </div>
          <!-- <div class="col-sm-3"  >
          <form method="post" class="form" action="./excel/partida_excel.php">
    ...
    <div class="table-responsive"> 
          <table class="table table-bordered border-blue table-light mt-3" >
            <tr>
              ...
              <th class="tbody_table bg-primary text-white">AUXILIAR</th>
              <th class="tbody_table bg-primary text-white">FORMULARIO</th>
              <th class="tbody_table bg-primary text-white">NOMBRE</th>
              <th class="tbody_table bg-primary text-white">EDITAR</th>
              <th class="tbody_table bg-primary text-white">ELIMINAR</th>   
            </tr>

            <?php
                 $sql_register= mysqli_query($conn,"SELECT COUNT(*) as total_registro FROM partidas where (REGISTRO LIKE '%busqueda')");?>
            <?php
      
                $columns = ['a.REGISTRO','a.CODIGO', 'a.FORMULA', 'a.AUXILIAR','a.FORMULARIO', 'a.NOMBRE','b.DESC'];
                $table = 'partidas a';
                $id = 'a.REGISTRO';
                ...
                FROM $table inner join formular b on a.FORMULARIO=b.id_formular
                $where";
                ...
                $sql_registe= mysqli_query($conn,"SELECT COUNT(*) as total_registro FROM partidas a inner join formular b on a.FORMULARIO=b.id_formular $where");
                ...
                $result=mysqli_num_rows($query);
                 ...
                 ?>
                  <tr>
                    ...
                    <td><?php  echo  substr($data['CODIGO'],0,$max_length="30"); ?></td>
                    <td><?php echo $data['FORMULA'];?></td>
                    <td><?php echo $data['AUXILIAR'];?></td>
                    <td><?php echo $data['FORMULARIO'];?></td>
                    <td><?php echo $data['DESC'];?></td>
                    <td> 
                   <a class="btn btn-success"  data-bs-toggle="modal" data-bs-target="#actualizarpartidas<?php echo $data["REGISTRO"];?>" > <i class="fa fa-dashboard"> </i>Editar </a>   
                    </td>
                     <td>
                ...
                <div class="modal-content bg-light w-100 m-lg-3 "  >
                  ...
                  <div class="modal-body" >
                      <form  class="row row-col-2"  id="frm" method="POST" action="#" enctype="multipart/form-data">
                          ...
                          <div class="col-sm-6" >
                            <label   for=""> <h6 style=" padding:1px">ID PARTIDAS</h6> <input class="form-control" id="ID_PARTIDAS" type="text" name="ID_PARTIDAS" required></label> 
                          </div>
                          ...
                          <div class="col-sm-6" style="padding:0px 0px 0px 10px;">
                             <label for="" class="align-content-center"> <h6 style=" padding:1px" >  AUXILIAR</h6><input  name="AUXILIAR"  autocomplete="off" type="text" class="form-control" id="AUXILIAR"  required > </label>
                          </div> 
                          <div class="col-sm-6" style="padding:0px 0px 0px 10px;">
                             <label for="" class="align-content-center"> <h6 style=" padding:1px" >  FORMULARIO</h6><input  name="FORMULARIO"  autocomplete="off" type="text" class="form-control" id="FORMULARIO"  required > </label>
                          </div>   
                          <div class="col-sm-6" style="padding:0px 0px 0px 10px;">
                             <label for="" class="align-content-center"> <h6 style=" padding:1px" >  NOMBRE</h6><input  name="NOMBRE"  autocomplete="off" type="text" class="form-control" id="NOMBRE"  required > </label>
                          </div>  
