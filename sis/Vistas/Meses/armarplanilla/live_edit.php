...
$update_field='';
    ...
    if($update_field!='' && $input['id_registro']!='') { 
        ...
        $sql_formula="UPDATE formulaxmes SET $sql_importe where REGMES='$mes' and REGPERSON='$id_user' and CODIGO='$cd' ";

        // $sql_formula="UPDATE formulaxmes SET ";
