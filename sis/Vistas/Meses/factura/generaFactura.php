<?php
	...
	$query1 =mysqli_query($conn,"SELECT f.NUMERO_DOC,f.NOMBRE,f.APELLIDOS,f.CARGO,f.id_categori,f.CTA_CTE,f.id_afps,p.REGPERSO,p.IMPORTE,p.DESCT FROM reportxplanilla p inner join datperso f on p.REGPERSO=f.id_datperso  
