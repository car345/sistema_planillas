...
<div class="container-fluid">
    <div class="row ">
    <div class="col-sm-4"  >
             <button type="button" class="btn btn-warning m-3 text-white " data-bs-toggle="modal"  data-bs-target="#agregarmodalidad" href="" id="nueva_curso" ><i class="bi bi-plus-square"></i> AGREGAR MODALIDAD</button>
          </div>
          <!-- <div class="col-sm-4"  >
          <form method="post" class="form" action="./excel/excel_modalidades.php">
    ...
    <div class="table-responsive"> 
          ...
          <thead><!--thead -->
            <tr>
              <th class="tbody_table" >REGISTRO </th>
              <th class="tbody_table">CODIGO</th>
              <th class="tbody_table">DESC</th>
              <th class="tbody_table">FEDU</th>
              <th class="tbody_table">EDITAR</th>
              <th class="tbody_table">ELIMINAR</th>   
            </tr>
            </thead><!--thead -->
            <tbody><!--tbody -->            
            <?php
  $columns = ['p.id_modali', 'p.CODIGO', 'p.DESC', 'p.FEDU'];
  $table = 'modali p';
  $id = 'p.id_modali';
  ...
  if (isset($_GET['enviar'])) {
      ...
      $where .= ")";
                ...
                $result=mysqli_num_rows($query);
                 ...
                 ?>
                  <tr >
                  <td ><?php echo $data['id_modali'];?></td>
                    <td><?php echo $data['CODIGO'];?></td>
                    <td><?php  echo  substr($data['DESC'],0,$max_length="30"); ?></td>
                    <td><?php  echo  substr($data['FEDU'],0,$max_length="30"); ?></td>
                    <td><a class="btn btn-success"  data-bs-toggle="modal" data-bs-target="#actualizarmodalidad<?php echo $data["id_modali"];?>" > <i class="fa fa-dashboard"> </i>Editar </a>   
                    </td>
                  <td>
                 <a class=" btn btn-danger text-center"   onclick="eliminar('<?php echo $data["id_modali"]; ?>')" >  Eliminar </a>
                 </td>
                  </tr>
                  <?php 
  ...
  <div class="modal fade" id="agregarmodalidad"  tabindex="-1">
            <div class="modal-dialog" style="border-radius: 10px;">
                <div class="modal-content bg-light w-100 m-lg-3 "  >
                    <div class="modal-header bg-light  ">
                  
                    <span class="fw-bold">Registrar Modalidad</span>
                  ...
                  <div class="modal-body" >
                      <form  class="row row-col-2"  id="frm" method="POST" action="#" enctype="multipart/form-data">
                          <div class="row row-col-2 ">
                            ...
                            <input class="form-control" placeholder="id" type="hidden" name="agregarmodalidad" value="agregarmodalidad">
                          
                          <div class="col-sm-6" >
                            <label   for=""> <h6 style=" padding:1px">ID MODALIDAD</h6> <input class="form-control" id="id_modalidad" type="text" name="id_modalidad" required></label> 
                          </div>
                          <div class="col-sm-6" style="padding:0px 0px 0px 10px;">
                             <label for="" class="align-content-center"> <h6 style=" padding:1px" >  CODIGO </h6><input  name="codigo_modalidad"  autocomplete="off" type="text" class="form-control" id="codigo_modalidad"  required > </label>
                          </div>  
                          <div class="col-sm-6" style="padding:0px 0px 0px 10px;">
                             <label for="" class="align-content-center"> <h6 style=" padding:1px" >  DESCRIPCION</h6><input  name="descripcion_modalidad"  autocomplete="off" type="text" class="form-control" id="descripcion_modalidad"  required > </label>
                          </div>
                          <div class="col-sm-6" style="padding:0px 0px 0px 10px;">
                             <label for="" class="align-content-center"> <h6 style=" padding:1px" >  FEDU </h6><input  name="fedu_modalidad"  autocomplete="off" type="text" class="form-control" id="fedu_modalidad"  required > </label>
                          </div>  
                          <button class=" btn px-3 btn-primary btn  mt-3" style="position:relative;left: 7px;"    type="button" id="registrar"  >REGISTRAR MODALIDAD</button>
                          <div>
