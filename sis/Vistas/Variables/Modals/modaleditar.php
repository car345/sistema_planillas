            ...
            <div class="modal-body" >
                <form method="POST" action="#" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6" style="padding:0px 0px 0px 10px; display:none;">
                        ...
                        <div class="col-sm-6" >
                            <label   for=""> <h6 style=" padding:1px">CODIGO CONCEPTO</h6> <input class="form-control" id="cc<?php echo  $data["REGISTRO"];?>" type="text" name="cc<?php echo  $data["REGISTRO"];?>" value="<?php echo $data["CODIGOC"];?>"></label>
                        </div>                        
                    </div>
