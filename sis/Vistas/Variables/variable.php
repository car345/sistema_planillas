...
<!-- Buscador-->
    ...
    <div class="table-responsive"> 
          <table class="table table_id table-bordered border-blue  table-light mt-3" >
            ...
            <tbody>
<?php
  $columns = ['p.CODIGO', 'p.DESCT', 'p.APORTE', 'p.TRABA_EMP', 'p.id_categori','p.REGISTRO','p.IMP','p.LEE','p.VER','p.ENCARGADO',
'p.AUXILIAR','p.ANULAR','p.AFECTO','p.VABSOLUTO','p.INICIALIZA'];
  $table = 'aportes p';
  $id = 'p.REGISTRO';

  //$campo = isset($_POST['campo']) ? mysqli_escape_string($conexion, $_POST['campo']) : null;
  	$where = 'where (p.TIPOCR=0)';
          ...
          <div class="modal fade" id="agregaraporte"  tabindex="-1">
            <div class="modal-dialog" style="border-radius: 10px;">
                <div class="modal-content bg-light w-100 m-lg-3 "  >
                  ...
                  <span class='fw-bold'>Agregar Variable</span>
